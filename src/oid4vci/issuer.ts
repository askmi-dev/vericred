/**
 * Credential endpoint — issues SD-JWT-VC from holder data.
 * Includes pairwise pseudonym (HMAC-SHA256) and salted claim commitments.
 */
...
export function createCredentialRouter(pseudonymSecret: string): Router {
  ...
  router.post('/credentials', async (req, res) => {
    ...
    // Pairwise pseudonym (privacy layer from prototype, kept)
    ...
    // Salted commitments for each claim
